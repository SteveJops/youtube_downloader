...
def runnin_selenium(driver: webdriver.Chrome, url_source: str, time_: int, current_window: str) -> None:
...
if __name__ == "__main__":
    ...
    for url in getting_ids('yttool --playlist https://www.youtube.com/playlist?list=PLA0M1Bcd0w8yv0XGiF1wjerjSZVSrYbjh'):  # paste ref to playlist
